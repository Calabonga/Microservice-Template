...
using Calabonga.Microservice.RazorPages.Infrastructure.Main.DatabaseInitialization;

namespace Calabonga.Microservice.RazorPages.Web.Definitions.DataSeeding;

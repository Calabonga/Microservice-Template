...
namespace Calabonga.Microservice.RazorPages.Infrastructure.Main.ModelConfigurations.Base;
...
public abstract class AuditableModelConfigurationBase<T> : IEntityTypeConfiguration<T> where T : Auditable
{
    public void Configure(EntityTypeBuilder<T> builder)
    {
        ...
        (
            src => src != null && src.Value.Kind == DateTimeKind.Utc ? src.Value : DateTime.SpecifyKind(src!.Value, DateTimeKind.Utc),

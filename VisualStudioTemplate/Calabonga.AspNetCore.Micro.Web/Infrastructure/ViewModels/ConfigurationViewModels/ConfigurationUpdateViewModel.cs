...
namespace $safeprojectname$.Infrastructure.ViewModels.ConfigurationViewModels
{
    /// <summary>
    /// ViewModel for Configuration Update
    /// </summary>
    public class ConfigurationUpdateViewModel
    {
        /// <summary>
